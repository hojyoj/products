...
class Master(QtGui.QFrame):
    ...
    def init(self):
        # print "    products.view.Master.init()"
    ...
    # def loadProductLines(self):
        # self.cnt.productLinesChanged = True
        # self.manager.loadLines()
        ## self.capture.loadLines()
...
class Manager(cdFrame.CDFrame):
    ...
    def __init__(self, *args, **kwds):
        """products.view.Manager.__init__()"""
    ...
    def loadSuppliers(self):
        ...
        if not self.mst._localAceptionIsHidden:
            self.ui.cbProveedor.addItem("Local", self.cnt.app.holder['id'])
...
class Capture(QtGui.QFrame):
    ...
    def init(self):
        ...
        # print("""        products.Capture.init() - END""")
...
#        sizePolicy.setHeightForWidth(lineCB.sizePolicy().hasHeightForWidth())
    ...
    def brand_update(self):
        # print("""        products.Capture.brand_update()""")
        ...
        # print("""        products.Capture.brand_update() - END""")
...
#        self.priceFinal = []
    ...
    def divisions_load(self):
        # print("""        products.Capture.divisions_load()""")
        ...
        # print("""        products.Capture.divisions_load() - END""")
    ...
    def loadLines(self):
        # print("""        products.Capture.loadLines()""")
        ...
        if not lines:
            self.app.stdoutLog.error("    products Capture.loadLines()\n        WARNING: {}".format(lines))
        ...
        # print("""        products.Capture.loadLines() - END""")
    ...
    def save(self, **kwds):
        ...
        try:
            ...
            if 'lines' in product.keys():
                ...
                self.app.stdoutLog.error("    products Capture.save()\n        WARNING: lines changed\n        {}".format(product))
