...
class Controller(QtCore.QObject):
	...
	def __init__(self, *args, **kwds):
		...
		self.app.log2sys ( 'debug', "			Controller.__init__() 							@ products" )
		...
		self.model = model.Model( self.app )
		...
		self.app.log2sys ( 'debug', "			Controller.__init__() - end						@ products\n" )


	def init(self, withViews=True):

		self.app.log2sys ( 'debug', "			Controller.init() 								@ products" )
		...
		self.app.log2sys ( 'debug', "			Controller.init() - end							@ products\n" )
	...
	def activePriceRules(self):
		return self.model.get_activePriceRules()
	...
	def lines_pull(self, **kwds):
		self.app.log2sys ( 'debug', "				Controller.lines_pull()					@ products" )

		kwds['category'] = 'line'
		lines = self.app.model.attributes_get(**kwds)

		self.app.log2sys ( 'debug', "				Controller.lines_pull() - end				@ products" )
