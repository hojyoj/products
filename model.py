...
class Model:
    ...
    def plug(self):
        ...
        self.model.getActivePriceRules = self.getActivePriceRules
    ...
    #        print attributes
            ...
            try:
                ...
                self.model.app.stdoutLog.error("\n    products Model products_full_pull()")
                self.model.app.stdoutLog.error("    {}".format(sys.exc_info()))
                self.model.app.stdoutLog.error("    {}".format(reversed))
                raise
